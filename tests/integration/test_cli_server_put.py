...
class TestCLIServerPut:
    ...
    def test_put_simple_credential(self, run_mattstash_cli, cli_env):
        ...
        result = run_mattstash_cli(["put", "simple-secret", "--value", "simple-value"], cli_env)
    ...
    def test_put_full_credential(self, run_mattstash_cli, cli_env):
        ...
        result = run_mattstash_cli(["get", "full-cred", "--show-password"], cli_env)
    ...
    def test_update_credential(self, run_mattstash_cli, cli_env):
        ...
        # Create initial
        run_mattstash_cli(["put", "update-test", "--value", "initial"], cli_env)

        # Update
        result = run_mattstash_cli(["put", "update-test", "--value", "updated"], cli_env)
        assert result.returncode == 0

        # Verify update
        result = run_mattstash_cli(["get", "update-test", "--show-password"], cli_env)
    ...
    def test_put_with_notes(self, run_mattstash_cli, cli_env):
        ...
        result = run_mattstash_cli(
            ["put", "noted-cred", "--value", "secret", "--notes", "This is a test note"], cli_env
        )
        assert result.returncode == 0
